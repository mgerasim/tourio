  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tour as @tour" do
        ...
        post :create, {:tour => { "registr" => "invalid value" }}, valid_session
        assigns(:tour).should be_a_new(Tour)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tour" do
        ...
        Tour.any_instance.should_receive(:update_attributes).with({ "registr" => "MyString" })
        put :update, {:id => tour.to_param, :tour => { "registr" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tour as @tour" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tour.any_instance.stub(:save).and_return(false)
        put :update, {:id => tour.to_param, :tour => { "registr" => "invalid value" }}, valid_session
        assigns(:tour).should eq(tour)
      end
