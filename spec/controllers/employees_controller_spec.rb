  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved employee as @employee" do
        ...
        post :create, {:employee => { "firstname" => "invalid value" }}, valid_session
        assigns(:employee).should be_a_new(Employee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested employee" do
        ...
        Employee.any_instance.should_receive(:update_attributes).with({ "firstname" => "MyString" })
        put :update, {:id => employee.to_param, :employee => { "firstname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the employee as @employee" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Employee.any_instance.stub(:save).and_return(false)
        put :update, {:id => employee.to_param, :employee => { "firstname" => "invalid value" }}, valid_session
        assigns(:employee).should eq(employee)
      end
